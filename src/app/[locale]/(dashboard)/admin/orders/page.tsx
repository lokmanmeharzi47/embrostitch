              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground">
                    {( (Array.isArray(selectedOrder.client) ? selectedOrder.client[0] : selectedOrder.client)?.first_name || (Array.isArray(selectedOrder.client) ? selectedOrder.client[0] : selectedOrder.client)?.last_name ) 
                      ? `${(Array.isArray(selectedOrder.client) ? selectedOrder.client[0] : selectedOrder.client)?.first_name || ""} ${(Array.isArray(selectedOrder.client) ? selectedOrder.client[0] : selectedOrder.client)?.last_name || ""}`.trim()
                      : "Client Anonyme"}
                  </p>
                </div>
                <div>
